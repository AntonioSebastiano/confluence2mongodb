...
public class ConfluenceSpacePermissionStepDefinition {
    ...
    public StaxEventItemReader<ConfluenceSpacePermission> confluenceSpacePermissionReader(ResourceProvider resourceProvider) {
        ...
        reader.setUnmarshaller(new Jaxb2Marshaller(){{  // Unmarshaller della libreria "corretto" da sostituire in tutti gli stepDefinition
            setClassesToBeBound(ConfluenceSpacePermission.class);
        }});
        return reader;
    }
